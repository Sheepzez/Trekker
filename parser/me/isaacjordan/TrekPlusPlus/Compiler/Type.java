...
public abstract class Type {
	...
	public static final Primitive VOID = new Primitive(0), BOOL = new Primitive(1), INT = new Primitive(2);

	public static final Error ERROR = new Error();

	/**
	 * Return true if and only if this type is equivalent to that.
	 * @param that
	 * @return
	 */
	...
	public static class Mapping extends Type {
		...
		public boolean equiv(Type that) {
			if (that instanceof Mapping) {
				Mapping thatMapping = (Mapping) that;
